  ...
  $user = UserInfo($url2);
    ...
    include 'blocks/userprofile.php';
    ?>
...
$TrCounter = 1;
     ...
     while ($i >= 1) {
       ...
       if ($quiz['poster'] != 'img') {
         ...
         $poster = "/resources/design/mainpicture.jpg";
       }
     ...
     if ($quiz['author'] == $url2 and $quiz['status'] != 'deleted') {
       if ($TrCounter == 1) {
         echo '<tr>';
       }
     ?>
     ...
     <td class="quiz"  id="<?php echo $i; ?>">
       <div class="quizBlock">
         ...
         <div class="bg"  style="background-image:url(<?php echo $poster; ?>)"  onclick="openQuiz(<?php echo $quiz['id']; ?>)"></div>
